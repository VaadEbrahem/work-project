...
function  typeNote(){
    if(container3.style.display == "none")   container3.style.display ="block";
...
function rotate(){
    let random_rotate = ["rotate(3deg)" , "rotate(1deg)" , "rotate(-1deg)" ,
    "rotate(-3deg)" ,"rotate(-5deg)","rotate(-10deg)"];
    return random_rotate[Math.floor(Math.random()*random_rotate.length)];
}

function color(){
    let  random_color = ["#e15f41" ,  "#303952" , "#3dc2ff" ,
